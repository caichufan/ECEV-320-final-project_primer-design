...
Conduct same extraction for primer length 19,20...24. All primers are in dataframe format. In the end, combine all the dataframes generated, and name it as "primer precursors". 
