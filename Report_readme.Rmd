...
My code first converts the DNA sequence from a .txt file to a dataframe. Then extracts all possible primers around position "b" with a length of 18bp: print all nucleotides between position "b-18" to "b+18". 
...
#a = primer length -1; here we use primer length 24 bp as an example
...
Conduct same extraction for primer length 18, 19, 20...23. All primers are in dataframe format. In the end, combine all the dataframes generated, and name it as "primer precursors". 
